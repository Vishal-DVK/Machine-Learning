...
model = pickle.load(open(r'C:\Users\visha\vscode project\ML\SLR1\linear_regression_model.pkl','rb'))
...
st.write("The model was trained using a dataset of House Price and Square Footage")